...
make >/dev/null
cd ../../../..
cp ../dist/core/xt/"$1"/Debug/libxt-audio.so ../dist/cpp/sample/"$1"/Debug/libxt-audio.so || :
...
make >/dev/null
cd ../../../..
cp ../dist/core/xt/"$1"/Release/libxt-audio.so ../dist/cpp/sample/"$1"/Release/libxt-audio.so || :