...
cd native\win32
cmake ..\.. -G"Visual Studio 16 2019" -DXT_ENABLE_ALSA=0 -DXT_ENABLE_JACK=0 -DXT_ENABLE_PULSE_AUDIO=0 -DXT_ENABLE_DIRECT_SOUND=%1 -DXT_ENABLE_WASAPI=%2 -DXT_ENABLE_ASIO=%3 -DXT_ASIOSDK_DIR=%4 -DXT_ASMJIT_DIR=%5 > NUL
