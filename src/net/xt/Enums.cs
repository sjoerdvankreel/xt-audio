...
namespace Xt
{
    ...
    [Flags] public enum XtServiceCaps : int { None = 0x0, Time = 0x1, Latency = 0x2, FullDuplex = 0x4, Aggregation = 0x8, ChannelMask = 0x10, ControlPanel = 0x20, XRunDetection = 0x40 }
}