...
namespace Xt
{
	...
	{
		static void Callback(XtStream stream, in XtManagedBuffer buffer, in XtTime time, ulong error, object user)
		{
			Buffer.BlockCopy(buffer.input, 0, buffer.output, 0, buffer.frames * 2 * 4);
		}
