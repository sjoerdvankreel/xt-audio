...
namespace Xt
{
    ...
    {
        [DllImport("xt-core")] internal static extern IntPtr XtPrintErrorInfoToString(ref XtErrorInfo info);
        [DllImport("xt-core")] internal static extern IntPtr XtPrintLocationToString(ref XtLocation location);
